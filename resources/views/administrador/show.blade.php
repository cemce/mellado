        ...
        <div class="row">
            <div class="col">
                ...
                <div class="grey-icon-wrapper col-sm-4">
                    <div class="text-block"><b>DIRECCIÓN:</b> {{$item->direccion}}<br><br><b>TÈCNICO:</b> {{$item->tecnico}}<br><br><b>ADMIN:</b> {{$item->administrador}}</div><a href="{{ route('comunidades.show', $item->comunidad) }}" ><img src=" {{ asset('foto/b3ccd57b054a73af1a0d281265b54ec8.jpg') }}" loading="lazy" width="60" height="60" srcset="" sizes="60px" alt="" class="image"></a>
                </div>
                    @endforeach
                    @include ('no-records')
            </div>
