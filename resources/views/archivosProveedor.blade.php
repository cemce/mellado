            ...
            <div class="col">
                ...
                <div class="grey-icon-wrapper col-sm-4">
                    <div class="text-block">
                        ...
                        <input type="hidden" value=" {{ $proveedor->id}} " name="proveedorid">
...
@if (Auth::user()->role == "adminfinca" ||Auth::user()->role == "comercial")
                        ...
                        <div class="grey-icon-wrapper col-sm-4">
                            <div class="text-block">
                                ...
                                @if (empty ($archivos->lopd) || empty($archivos->visita) || empty($archivos->informe))
                                        ...
                                        <label> Faltan archivos, contacta con <br> <a href =" {{ route ('enviar.email' , $proveedores->nombreproveedor) }} "> <p class="link">{{strtoupper($proveedores->nombreproveedor)}} </p></a></label>
                                @endif
