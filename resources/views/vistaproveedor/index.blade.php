        ...
        <div class="row">
            <div class="col">
                ...
                <div class="grey-icon-wrapper w-col-small-3">
                    ...
                    <a href="{{ route('vistaproveedor.show', $item->comunidad) }}" ><img src=" {{ asset('foto/b3ccd57b054a73af1a0d281265b54ec8.jpg') }}" loading="lazy" width="60" height="60" srcset="" sizes="60px" alt="" class="image"></a>
